                         ...
                         <div class="table-holder">                            
                                <div class="verlof-table">
                                    <div class="verlof-table-block">
                                        <div class="verlof-table-item"><h4>Aangevraagd door</h4> <p>{{ $verlofAanvragen->user->first_name }} {{ $verlofAanvragen->user->last_name }}</p> </div>
                                        <div class="verlof-table-item"><h4>Begin tijd</h4> <p>{{ $verlofAanvragen->begin_tijd }}</p> </div>
                                        <div class="verlof-table-item"><h4>Begin datum</h4> <p>{{ $verlofAanvragen->begin_datum }}</p> </div>
                                        <div class="verlof-table-item"><h4>Eind tijd</h4> <p>{{ $verlofAanvragen->eind_tijd }}</p> </div>
                                        <div class="verlof-table-item"><h4>Eind datum</h4> <p>{{ $verlofAanvragen->eind_datum }}</p> </div>
                                        <div class="verlof-table-item"><h4>Reden</h4> <p>{{ $verlofAanvragen->reden }}</p> </div>
                                        <div class="verlof-table-item"><h4>Status</h4> <p>{{ $verlofAanvragen->status }}</p> </div>
                                    </div>
                                </div>
                           </div>
